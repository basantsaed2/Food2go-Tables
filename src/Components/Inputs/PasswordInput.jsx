                     ...
                     <div className="relative w-full h-14">
                            <input
                                   ...
                                   className={classNames(
                                          `w-full h-full border-2 rounded-2xl outline-none px-2 py-3 text-2xl shadow bg-${backgound} font-TextFontRegular text-fourthColor`,
                                          ...
                                          paddingRight, // Dynamic padding right
                                          {
                                                 ...
                                                 'border-fourthColor': borderColor === 'fourthColor', // Example of another color
                                          }
                                   )}
                                   value={value}
                                   onChange={onChange}
