       ...
       return (
              <>
                     <div className="relative w-full h-12 shadow-sm">
                       ...
                       outline-none p-2 py-3 shadow cursor-pointer ${paddinLeft} ${paddinRight} text-2xl  ${placeholderSize ? 'text-lg' : 'text-2xl'} font-normal eleValueInput ${upload ? "text-mainColor cursor-pointer pr-10" : "text-fourthColor"}`}
                                   value={value}
                                   onClick={onClick}
                                   onChange={onChange}
                                   readOnly={readonly}
