...
const OffersProducts = () => {
  ...
  useEffect(() => {
    if (!scrollContainerRef.current || !isPlaying || !offerProductsData || offerProductsData.length === 0) return;
  ...
  }, [isPlaying, offerProductsData, isRTL]);
              ...
              {offerProductsData.map((product) => (
                ...
                >
                  <div className="relative w-full h-48 overflow-hidden">
                    ...
                    {/* Discount badge */}
                    <div className={`absolute top-2 ${isRTL ? 'right-2' : 'left-2'} bg-red-500 text-white px-2 py-1 rounded-full text-xs font-semibold`}>
